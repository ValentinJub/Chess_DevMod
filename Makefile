...
SRCS = src/*.cpp src/com/*.cpp src/sound/*.cpp src/states/*.cpp src/states/game/*.cpp src/states/menu/*.cpp src/menu/*.cpp src/utils/*.cpp src/factories/*.cpp src/graphics/*.cpp src/game/pieces/*.cpp src/game/board/*.cpp
