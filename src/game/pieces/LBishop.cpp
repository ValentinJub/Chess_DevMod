...
std::vector<SDL_Point> LBishop::moves(std::array<std::array<int, SPL>, SPL> map, SDL_Point bishopPos) {
	std::vector<SDL_Point> legalPos;
	for(int i(0); i < 4; i++) {
		SDL_Point nextPos = {bishopPos.x + Moves[i].x, bishopPos.y + Moves[i].y};
